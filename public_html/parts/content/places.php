<meta name="theme-color" content="#4234a1">
<style media="screen">
.scroll {
  background: #4234a1 !important;
}
.hero{
  background-image: url(https://пермьонлайн.рф/assets/images/galery.jpg);
}
.hero:after {
  --hero_gd_f: #071dff;
  --hero_gd_t: #ff621b;
...
<?php
  ...
  $Param1 = 'SELECT `id`, `name`, `description`,`comment_api`,`map_api`,`image_name`, `gd_from`, `gd_to` FROM `places`';
      ...
      <div class="row">
        ...
        <div class="col-md-6 toppad">
            ...
            <div class="col-md-12 announce">
              ...
              <p style = " width: 440px;  height: 16px;"><a href = "/places_page/'.$Row['id'].'/">Подробнее</a></p>
              </div>
