<meta name="theme-color" content="#c38f36">
<style media="screen">
.scroll {
  background: #c38f36 !important;
}
.hero{
  background-image: url(https://пермьонлайн.рф/assets/images/city1.jpg);
}
.hero:after {
  --hero_gd_f: #e2b005;
  --hero_gd_t: #4d0c99;
...
<?php
  ...
  $Param1 = 'SELECT `id`, `name`, `description`,`comment_api`,`map_api`,`image_name`, `gd_from`, `gd_to` FROM `ivents`';
      ...
      <div class="row">
        ...
        <div class="col-md-6 toppad">
            ...
            <div class="col-md-12 announce">
              ...
              <p style = " width: 440px;  height: 16px;"><a href = "/ivents_page/'.$Row['id'].'/">Подробнее</a></p>
              </div>
